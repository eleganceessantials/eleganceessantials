          ...
          <div className="lg:col-span-5">
            <div className="flex items-center gap-3">
              <img
                src="/logo.png"
                alt="Logo"
                className="w-12 h-12 rounded-2xl object-cover shadow-sm bg-white p-1"
              />
            ...
            <p className="mt-4 text-white/75 max-w-md leading-relaxed">
              Premium beauty essentials curated for glow, confidence, and
              everyday elegance. Authentic products, fast delivery, and easy
              returns — always.
            </p>
            ...
            <div className="mt-7 flex items-center gap-4">
              ...
              <a
                ...
                className="group flex h-12 w-12 items-center justify-center rounded-full border border-white/12 bg-white/5 text-white/85 transition hover:border-[#DB005B]/50 hover:bg-[#DB005B]/15 hover:text-[#DB005B]"
              ...
              {[
                {
                  ...
                  hoverClass:
                    "hover:bg-[#1877F2]/15 hover:border-[#1877F2]/50 hover:text-[#1877F2]",
                  icon: (
                ...
                },
                {
                  ...
                  hoverClass:
                    "hover:bg-[#E4405F]/15 hover:border-[#E4405F]/50 hover:text-[#E4405F]",
                  icon: (
                    <g
                      fill="none"
                      stroke="currentColor"
                ...
                },
                {
                  ...
                  hoverClass:
                    "hover:bg-white/15 hover:border-white/50 hover:text-white",
                  icon: (
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={s.label}
                  className={`group w-11 h-11 rounded-full bg-transparent border border-white/12 flex items-center justify-center transition cursor-pointer ${s.hoverClass}`}
                >
                  <svg
          ...
          <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="mt-4 space-y-2.5 text-white/72">
                ...
                <li className="pt-2">
                  <Link
                    className="text-[#DB005B] font-bold hover:underline transition"
